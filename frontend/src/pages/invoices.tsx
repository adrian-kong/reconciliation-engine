    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-1">
          {['all', 'pending', 'matched', 'partially_matched'].map((status) => (
            <button
              key={status}
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border text-left">
              <th className="p-4 text-xs font-medium text-muted-foreground">Invoice</th>
              <th className="p-4 text-xs font-medium text-muted-foreground">Vendor</th>
              <th className="p-4 text-xs font-medium text-muted-foreground text-right">Amount</th>
              <th className="p-4 text-xs font-medium text-muted-foreground">Due Date</th>
